Component({
  ...
  lifetimes: {
    attached() {
      const {
        checked, checkedColor, uncheckedColor, checkedTextColor, uncheckedTextColor, size
      } = this.properties
      ...
      this.setData({
        checkedClass: checked ? 'custom-radio-selected' : '',
  ...
  observers: {
    checked(newVal) {
      const {
        checkedColor, uncheckedColor, checkedTextColor, uncheckedTextColor, size
      } = this.properties
      ...
      this.setData({
        checkedClass: newVal ? 'custom-radio-selected' : '',
        iconStyle: `background-color: ${backgroundColor};
                   border-color: ${borderColor};
                   top: ${top};
                   width: ${width};
